...
def run(args):
    ...
    try:
        ...
        ret['listweeksumresponse']['count'] = int(cursor.fetchall()[0][0])
...
# 'stockid':'000001',  'starttime':'2000-01-01',  'endtime':'2014-01-01',  'sortname':'bull_profit'
    print run( {'starttime':'2000-01-01',  'endtime':'2014-01-01',  'sumtype':'all',  'sumname':'avg_price',  'weeks':'3',  'page':'1',  'pagesize':1000,  'sortname':'threeweeksum'})